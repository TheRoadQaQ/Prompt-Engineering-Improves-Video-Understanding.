...
def collate_fn(batch):
    ...
    prefixes  = [x['prefix'] for x in batch]
    ans  = [x['answer'] for x in batch]
    return vid, v_id, qus, prefixes, ans
...
def run_inference(args):
    ...
    for i, (video_paths, video_names, questions, prefixes, answers) in enumerate(tqdm(dataloader)):
